...
import {Blake3Sol} from "src/Blake3Sol.sol";
...
contract Blake3SolTest is Test {
    ...
    function test_hash() public {
        ...
        assertEq(bytes32(output), 0x10e6acb2cfcc4bb07588ad5b8e85f6a13f19e24f3302826effd93ce1ebbece6e);
    }
    ...
    function test_keyed_hash() public {
        ...
        assertEq(bytes32(output), 0x0edd7e645d2bc1bba1f323f6339a3d0448ec6b675991e8dc76d2396eb0dffca2);
    }
    ...
    function test_big_hash_ffi() public {
        ...
        Blake3Sol.Hasher memory hasher = Blake3Sol.new_keyed(
            abi.encodePacked(bytes32(0xc811f2ef6eb6bd09fb973c747cbf349e682393ca4d8df88e5f0bcd564c10a84b))
        );
